            ...
            <div class="container hidden-xs">
               <div class="row">
                  <div class="col-md-4 col-sm-5 detail-img">
                     <div id="carousel-example-big-sm" data-interval="false" class="carousel slide visible-sm">
                        ...
                        <div class="carousel-inner">
                           <div class="item active">
                              <a class="fancybox" rel="group" href="index.html"><img alt="" src="{!! url('resources/upload/'.$products_detail->image) !!}" class="img-thumbnail"></a>
                           </div>
                           <div class="item ">
                              <a class="fancybox" rel="group" href="index.html"><img alt="" src="{!! url('resources/upload/'.$products_detail->image) !!}" class="img-thumbnail"></a>
                           </div>
                     ...
                     <div class="item">
                        <img id="mainfutured" src="{!! url('resources/upload/'.$products_detail->image) !!}" class="img-thumbnail" />
                     </div>
                  </div>
                  <div class="col-md-8 col-sm-7">
                     <div class="kk-product-detail">
                        <h1 class="name">{!! $products_detail->name !!}</h1>
                        <div class="detail">
                           <div itemprop="description">
                              <p>{!! $products_detail->intro !!}</p>
                           </div>
                           <p>
                           <div class="cart pull-right">
                              <a href="{!! url('/gio-hang') !!}"><i class="fa fa-cart-plus"></i> Giỏ hàng <span class="number-cart">
                        ...
                        <div class="price-code">
                           <span class="price pull-left">{!! number_format($products_detail->price,0,",",".") !!} VND</span>
                           <span class="code pull-right">{!! $products_detail->keywords !!}</span>
                           <div class="clearfix"></div>
                        </div>
                        <div class="row color-size">
                           <div class="col-md-6 col-sm-6">
                              <span class="color">
                                 <p><span class="bold">Màu sắc:</span> {!! $products_detail->content !!}</p>
                                 <p><span class="bold">Chất liệu:</span> {!! $products_detail->description !!}</p>
                                 <p><span class="bold">Đánh giá:</span> <img src="{!! url('resources/upload/rato.png') !!}"></p>
                                 <p><div class="fb-share-button" data-href="{!! url('chi-tiet-san-pham',[$products_detail->id,$products_detail->alias]) !!}" data-layout="button_count" data-size="small" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fchaofashion.net%2Fchi-tiet-san-pham%2F13%2Fdam-voan-2-lop&amp;src=sdkpreparse">Chia sẻ</a></div>
                                <div class="fb-like" data-href="{!! url('chi-tiet-san-pham',[$products_detail->id,$products_detail->alias]) !!}" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="false"></div>
                        ...
                        <div class="btn-control">
                           <div class="row" id="bdesktop">
                              <form class="variations_form cart" action="{!! route('themgiohang',$products_detail->id) !!}" method="get" onsubmit="return checkadd();" enctype='multipart/form-data'>
                        ...
                        <div class="thumbnail-slide">
                           <div id="owl-demo" class="owl-carousel">
                              <!-- Wrapper for slides -->
                              <div class="item"><a href="javascript:void(0)" onclick="changefutureimg('{!! url('resources/upload/'.$products_detail->image) !!}')"  class=" img-thumbnail" title="{!! $products_detail->name !!}" ><img src='{!! url('resources/upload/'.$products_detail->image) !!}' /></a></div>
                              @foreach($image as $item_image)
                              <div class="item"><a href="javascript:void(0)" onclick="changefutureimg('{!! url('resources/upload/detail/'.$item_image->image) !!}')"  class=" img-thumbnail" title="{!! $products_detail->name !!}" ><img src='{!! url('resources/upload/detail/'.$item_image->image) !!}' /></a></div>
                              @endforeach
                           </div>
                           <script type="text/javascript">
                  ...
                  <div class="col-md-9 step-item step-detail">
                     ...
                     <div class="tab-content">
                        <div align="center" id="step-1" class="tab-pane fade in active">
                           <img src="{!! url('resources/upload/'.$products_detail->image) !!}" alt='Đầm công sở KK66-21' title='{!! $products_detail->name !!}' class="img-thumbnail" />
                           @foreach($image as $item_image)
                           <img src="{!! url('resources/upload/detail/'.$item_image->image) !!}" alt='Đầm công sở KK66-21' title='{!! $products_detail->name !!}' class="img-thumbnail" />
                           @endforeach
                        ...
                        <div id="step-2" class="tab-pane fade">
                           ...
                           <img src="{!! url('resources/upload/images/huongdan-1.jpg') !!}">
                           ...
                           <img src="{!! url('resources/upload/images/huongdan-2.jpg') !!}">
                           ...
                           <img src="{!! url('resources/upload/images/huongdan-3.jpg') !!}">
                           <br /> <!-- thong tin bank --> 
                           <br /> 
                           <br /> 
                           <!-- <div>
                              ...
                              <div class="col-md-12 col-xs-12 content-step-3">
                                 <div class="row content-step-bank">
                                    <div align="center" class="col-md-5 col-xs-5 col-sm-5">
                                       <a href="index.html"><img src="{!! url('resources/upload/images/bank-info-1.png ') !!}" alt=""></a>
                                    </div>
                                 ...
                                 <div class="row content-step-bank">
                                    <div align="center" class="col-md-5 col-xs-5 col-sm-5">
                                       <a href="index.html"><img src="{!! url('resources/upload/images/bank-info-2.png ') !!}" alt=""></a>
                                    </div>
                                    <div class="col-md-7 col-xs-7 col-sm-7">
                                 ...
                                 <div class="row content-step-bank">
                                    <div align="center" class="col-md-5 col-xs-5 col-sm-5">
                                       <a href="index.html"><img src="{!! url('resources/upload/images/bank-info-3.png ') !!}" alt=""></a>
                                    </div>
                                    <div class="col-md-7 col-xs-7 col-sm-7">
                                 ...
                                 <div class="row content-step-bank">
                                    <div align="center" class="col-md-5 col-xs-5 col-sm-5">
                                       <a href="index.html"><img src="{!! url('resources/upload/images/bank-info-4.png ') !!}" alt=""></a>
                                    </div>
                                    <div class="col-md-7 col-xs-7 col-sm-7">
                                 ...
                                 <div class="row content-step-bank">
                                    <div align="center" class="col-md-5 col-xs-5 col-sm-5">
                                       <a href="index.html"><img src="{!! url('resources/upload/images/bank-info-5.png ') !!}" alt=""></a>
                                    </div>
                                    <div class="col-md-7 col-xs-7 col-sm-7">
                                 ...
                                 <div class="row content-step-bank">
                                    <div align="center" class="col-md-5 col-xs-5 col-sm-5">
                                       <a href="index.html"><img src="{!! url('resources/upload/images/bank-info-6.png ') !!}" alt=""></a>
                                    </div>
                                    <div class="col-md-7 col-xs-7 col-sm-7">
                                 ...
                                 <div class="row content-step-bank">
                                    <div align="center" class="col-md-5 col-xs-5 col-sm-5">
                                       <a href="index.html"><img src="{!! url('resources/upload/images/bank-info-7.png ') !!}" alt=""></a>
                                    </div>
                                    <div class="col-md-7 col-xs-7 col-sm-7">
                        ...
                        <div id="step-3" class="tab-pane fade">
                           <div class="fb-comments" data-href="{!! url('chi-tiet-san-pham',[$products_detail->id,$products_detail->alias]) !!}" data-numposts="5"></div>
                        </div>
                     </div>
                  </div>
                  <div class="hidden-sm">
                           ...
                           <div class="col-md-12 col-xs-12">
                              <div class="kk-special mCustomScrollbar">
                                 <div class="woocommerce">
                                    <ul class="products">
                                       <ul>
                                       	@foreach($products_cate as $item_products_cate)
                                          <li>
                                             <div class="prothumb" ele="107291">
                                                <a href="{!! url('chi-tiet-san-pham',[$item_products_cate->id,$item_products_cate->alias]) !!}"> 
                                                <img src="{!! url('resources/upload/'.$item_products_cate->image) !!}" class="img-thumbnail shop-imgs" data="{!! url('chi-tiet-san-pham',[$item_products_cate->id,$item_products_cate->alias]) !!}"/>
                                                </a>
                                             </div>
                                             <p> <a href="{!! url('chi-tiet-san-pham',[$item_products_cate->id,$item_products_cate->alias]) !!}">{!! $item_products_cate->name !!}</a></p>
                                             <p ><b>{!! number_format($item_products_cate->price,0,",",".") !!} đ</b></p>
                                          </li>
                                        @endforeach
                                       </ul>
                                    </ul>
               ...
               <div class="row">
                  <div class="col-xs-12 detail-img">
                     <div id="slideshow-page" class="owl-carousel owl-theme">
                        <div class="item">
                           <img alt="" src="{!! url('resources/upload/'.$products_detail->image) !!}" class="img-thumbnail">
                        </div>
                        @foreach($image as $item_image)
                        <div class="item">
                           <img alt="" src="{!! url('resources/upload/detail/'.$item_image->image) !!}" class="img-thumbnail">
                        </div>
                        @endforeach
                     </div>
                  </div>
                  <div class="col-xs-12">
                     <div id="owl-demo" class="owl-carousel">
                        <!-- Wrapper for slides -->
                        <div class="item"><a href="javascript:void(0)" onclick="changefutureimg('{!! url('resources/upload/'.$products_detail->image) !!}')"  class=" img-thumbnail" title="Đầm công sở KK66-21" ><img src='{!! url('resources/upload/'.$products_detail->image) !!}' /></a></div>
                        @foreach($image as $item_image)
                        <div class="item"><a href="javascript:void(0)" onclick="changefutureimg('{!! url('resources/upload/detail/'.$item_image->image) !!}')"  class=" img-thumbnail" title="Đầm công sở KK66-21" ><img src='{!! url('resources/upload/detail/'.$item_image->image) !!}' /></a></div>
                        @endforeach
                     <script type="text/javascript">
                        jQuery(document).ready(function($) {
                  ...
                  <div class="col-xs-12">
                     <div class="kk-product-detail">
                        ...
                        <div class="detail">
                           <div itemprop="description">
                              <p> <p>{!! $products_detail->intro !!}</p></p>
                           </div>
                           {{-- <p>
                              <span class="tags pull-left">Tags: <a href="http://kkfashion.vn/san-pham/thoi-trang-cong-so/" rel="tag">Thời trang công sở</a>, <a href="http://kkfashion.vn/san-pham/vay-dam-cong-so/" rel="tag">Váy đầm công sở</a></span>
                           </p> --}}
                           <div class="clearfix"></div>
                        </div>
                     </div>
                           ...
                           <div id="collapse1" class="panel-collapse collapse in">
                              <div class="panel-body">
                                 <div class="post-thumb" align="center">
                                    <img src="{!! url('resources/upload/'.$products_detail->image) !!}" title='{!! $products_detail->name !!}' class="img-thumbnail" />
                                 </div>
                                 @foreach($image as $item_image)
                                 <div class="post-thumb" align="center">
                                    <img src="{!! url('resources/upload/detail/'.$item_image->image) !!}" alt='{!! $products_detail->name !!}' title='{!! $products_detail->name !!}' class="img-thumbnail" />
                                 </div>
                                 @endforeach
                           ...
                           <div id="collapse2" class="panel-collapse collapse">
                              <div class="panel-body">
                                 <div class="text">
                                    ...
                                    <img src="{!! url('resources/upload/images/huongdan-1.jpg') !!}" alt="">
                                    <img src="{!! url('resources/upload/images/huongdan-2.jpg') !!}" alt="">
                                    ...
                                    <img src="{!! url('resources/upload/images/huongdan-3.jpg') !!}" alt="">
                                    ...
                                    <img src="{!! url('resources/upload/images/huongdan-4.jpg') !!}" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
