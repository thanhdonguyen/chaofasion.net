            ...
            <div class="row">
               ...
               <div class="col-xs-12 hidden-md hidden-lg hidden-sm menu-mobile">
                  <ul>
                     ...
                     <li>
                        <a href="{!! url('/') !!}"><img src="{!! url('public/kkshop/wp-content/themes/kkfashion/asset/img/login-icon.png') !!}" alt="">
                        </a>
                     </li>
                     <li class="cart-icon">
                        <a href="{!! url('/gio-hang') !!}"><img src="{!! url('public/kkshop/wp-content/themes/kkfashion/asset/img/cart-icon.png') !!}" alt=""><span class="cart-number">
               ...
               <div class="col-md-2 col-sm-3 logo hidden-xs">
                  <a href="{!! url('/') !!}"><img src="{!! url('public/kkshop/wp-content/themes/kkfashion/asset/img/logo.png') !!}" alt="">
                  </a>
                     ...
                     <div class="container-fluid">
                        <div>
                           <ul class="nav navbar-nav">
                              ...
                              @foreach($menu_level_1 as $item_level_1)
                              <li class="dropdown">
                                 <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{!! $item_level_1->name !!}<span class="caret"></span></a>
               ...
               <div class="col-md-12 hidden-xs hidden-sm">
                  <div class="row">
                     <div class="col-md-12 login-cart-search">
                        <div class="search">
                           <form action="{!! url('/') !!}" role="search" method="get" id="searchform">
                              <input name="s" class="search-input" type="text" placeholder="Nhập mã sản phẩm cần tìm..." />
                              <a href="javascript:void(0)" onclick="$('#searchform').submit()"><i class="fa fa-search"></i></a>
                           </form>
                        </div>
                        <div class="cart">
                           <a href="{!! url('/gio-hang') !!}"><img src="{!! url('public/kkshop/wp-content/themes/kkfashion/asset/img/icon-cart.png') !!}" alt=""> Giỏ hàng <span class="number-cart">
                             @if(Session::has('cart')){!! Session('cart')->totalQty !!}
                            @else 0
                            @endif
                           </span>
