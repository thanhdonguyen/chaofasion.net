                        ...
                        <div class="btn-control" id="bmobile">
                              ...
                              <div class="single_variation_wrap" style="display:none;">
                                 ...
                                 <div class="variations_button">
                                    <div class="quantity"><input type="number" step="1"   name="quantity" value="1" title="SL" class="input-text qty text" size="4" /></div>
                                    <button type="submit" class="single_add_to_cart_button button alt">Thêm vào giỏ</button>
                                    <input type="hidden" name="add-to-cart" value="107281" />
                                    <input type="hidden" name="product_id" value="107281" />
                           ...
                           <a href="http://kkfashion.vn/shop/dam-cong-so-kk66-22/" rel="next"><button class="btn-back">Quay lại</button></a><a href="http://kkfashion.vn/shop/dam-cong-so-kk66-17/" rel="prev"><button class="btn-continue">Xem tiếp</button></a>
                        </div>
                        <div class="detail">
                           <div itemprop="description">
