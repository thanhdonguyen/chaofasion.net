...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Xin Chào <?php echo Auth::user()->username; ?></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo url('admin/dangxuat'); ?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo e(url('admin/bill/list')); ?>"><i class="fa fa-dashboard fa-fw"></i> Đơn hàng</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Menu<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo e(url('admin/cate/list')); ?>">Danh sách menu</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('admin/cate/add')); ?>">Thêm menu</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo e(url('admin/product/list')); ?>">Danh sách sản phẩm</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('admin/product/add')); ?>">Thêm sản phẩm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-cube fa-fw"></i> Slider<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo e(url('admin/slider/list')); ?>">Danh sách Slider</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('admin/slider/add')); ?>">Thêm Slider</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo e(url('admin/user/list')); ?>">List User</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('admin/user/add')); ?>">Add User</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><?php echo isset($header)?$header:null; ?>

                            <small style="color: red"><?php echo isset($name)?$name:null; ?></small>
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    <div class="col-lg-12">
    ...
    <script src="<?php echo e(url('public/admin/bower_components/DataTables/media/js/jquery.dataTables.min.js')); ?>">
    
    </script>
    
    <script src="<?php echo e(url('public/admin/js/myscrip.js')); ?>"></script>
