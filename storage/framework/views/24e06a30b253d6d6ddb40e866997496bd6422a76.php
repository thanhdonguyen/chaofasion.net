                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo e(url('admin/cate/list')); ?>">List Category</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('admin/cate/add')); ?>">Add Category</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo e(url('admin/product/list')); ?>">List Product</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('admin/product/add')); ?>">Add Product</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
